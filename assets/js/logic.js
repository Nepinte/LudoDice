...
function init() {
    ...
    // $(".winner-home .").append($(".red-home .white-box .player-room").html());
...
// function current_turn(color){
//   eval(color).style.background = "ivory";
//   turn = current_turn[next];
//
...
//
//   if (current_turn.group == 'RED'){
//     document.getElementById("dice_value").style.backgroundColor = '#99C262';
//   }
//   if (current_turn.group == 'GREEN') {
//     document.getElementById("dice_value").style.backgroundColor = '#99C262';
//   }
